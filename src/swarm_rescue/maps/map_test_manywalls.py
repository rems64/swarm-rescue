...
from .walls_medium_01 import add_walls, add_boxes


class MyMapManyWalls(MapAbstract):

    def __init__(self, zones_config: ZonesConfig = ()):
        super().__init__(zones_config)
        self._time_step_limit = math.inf
        self._real_time_limit = math.inf  # In seconds
